...
export function HomeSection({ onSelectModel }: HomeSectionProps) {
  return (
    <div className="min-h-full pb-4">
      <div className="px-5 pt-14 pb-6">
        ...
        <p className="text-muted-foreground text-sm mt-1">专业模特经纪 · 高端形象定制</p>
      </div>

      <div className="px-5 mb-6">
        <div className="bg-card rounded-[20px] p-4 shadow-[0_1px_3px_rgba(0,0,0,0.04)] flex items-stretch gap-0">
          <div className="flex-1 flex flex-col items-center justify-center py-2">
            ...
            <span className="text-xs text-muted-foreground mt-1">今日在班</span>
          </div>
