...
app.put(
  "/",
  csrf,
  zValidator("json", adminTypes.AdminRosterPutRequest),
  async (c) => {
...
app.post(
  "/copy",
  csrf,
  zValidator("query", adminTypes.AdminRosterCopyQuery),
  async (c) => {
...
app.delete(
  "/",
  csrf,
  zValidator("query", adminTypes.AdminRosterQuery),
  async (c) => {
    const { date } = c.req.valid("query");
...
app.get(
  "/history",
  zValidator("query", adminTypes.AdminRosterHistoryQuery),
  async (c) => {
    const { from, to } = c.req.valid("query");
